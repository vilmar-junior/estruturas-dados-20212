...
public class ListaEncadeada {
	...
	/**
	 * Verifica se um determinado valor consta na lista encadeada
	 *
	 * @param valor
	 ...
	 *
	 */
	public boolean existeElemento(Object valor) {
		boolean existe = false;
		
		Elemento elementoAtual = this.inicio;
		while(elementoAtual != null) {
			if(elementoAtual.getDado() == valor) {
				existe = true;
